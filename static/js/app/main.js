...
window.onload = async function() {
    ...
    try {
        ...
        if (Array.isArray(tData)) {
            allTemples = tData;
        } else if (tData.names && Array.isArray(tData.names)) {
            allTemples = tData.names;
        } else if (tData.temples && Array.isArray(tData.temples)) {
            allTemples = tData.temples;
        }
...
function updateTempleSelect() {
    ...
    const displayTemples = currentTab === 'favorites' 
...
function addMessage(text, sender, isLoading = false) {
    ...
    if (text.includes('<div') || text.includes('<button') || text.includes('<a')) {
        div.innerHTML = text;
    } else {
